...
const Playnow = () => {
  ...
  const { questions, currentQuestionIndex, score, questionsAttemptedCount, fetchNextQuestionSet, fetchPreviousQuestionSet, } = useSelector((state) => state.questionsStore);
        ...
        {questions.length > 0 && (
          <div className="question-section">
            <div className="score-display">
              <span>Score: {score}</span> | <span>Questions Attempted: {questionsAttemptedCount}</span>
            </div>
